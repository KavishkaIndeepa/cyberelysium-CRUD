...
use RegisterdUserController;
use PasswordResetLinkController;
use ConfirmablePasswordController;
use AuthenticatedSessionController;
use Illuminate\Support\Facades\Route;
use EmailVerificationPromptController;
